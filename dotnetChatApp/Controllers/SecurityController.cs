...
namespace dotnetChatApp.Controllers
{
    ...
    public class SecurityController : ControllerBase
    {
        ...
        public SecurityController(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, ISecurityService securityService)
        {
